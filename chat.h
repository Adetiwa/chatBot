...
//array of insultive words
std::string insults[] = {"idiot", "stupid", "fuck you", "mad"};
...
public:
	CBot (std::string str)
		:m_sBotName(str), m_bQuitProgram(0), m_sInput("null"), m_bTTSEngineInitialised(0), m_Emotions(5), userhasname(0) //m_pVoice(NULL)
	{
	...
	std::string getEmo() {
		...
		switch(m_Emotions) {
			case 1:
			emotion = "Extremely Angry";
			break;
			case 2:
			emotion = "Very Angry";
			break;
			case 3:
			emotion = "Really Angry";
			break;
			case 4:
			emotion = "Angry";
			break;
